...
def _setup_whatsapp_routes(app: FastAPI):
    ...
    try:
        ...
        from piopiy.transports.whatsapp.api import WhatsAppWebhookRequest
        from piopiy.transports.whatsapp.client import WhatsAppClient
    except ImportError as e:
...
def _setup_daily_routes(app: FastAPI, dialin_enabled: bool = False):
    ...
    async def start_agent(request: Request):
        ...
        if create_daily_room or existing_room_url:
            ...
            from piopiy.runner.daily import configure
            from piopiy.transports.daily.utils import (
    ...
    if dialin_enabled:
        ...
        async def handle_dialin_webhook(request: Request):
            ...
            from piopiy.runner.daily import configure
            from piopiy.runner.types import DailyDialinRequest, DialinSettings
