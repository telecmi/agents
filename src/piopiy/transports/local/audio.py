...
from piopiy.frames.frames import InputAudioRawFrame, OutputAudioRawFrame, StartFrame
...
try:
    ...
    logger.error(
        "In order to use local audio, you need to `pip install piopiy-ai[local]`. On MacOS, you also need to `brew install portaudio`."
    )
