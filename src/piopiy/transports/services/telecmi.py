...
This module provides comprehensive TeleCMI real-time communication integration
...
from piopiy.processors.frame_processor import FrameDirection, FrameProcessorSetup
...
try:
    ...
    logger.error("In order to use TeleCMI, you need to `pip install piopiy-ai[telecmi]`.")
...
class TeleCMITransportClient:
    ...
    def participant_id(self) -> str:
        ...
        Returns:
            The participant ID assigned by TeleCMI.
        """
    ...
    async def connect(self):
        """Connect to the TeleCMI room with retry logic."""
        if self._connected:
    ...
    async def publish_audio(self, audio_frame: rtc.AudioFrame):
        ...
        Args:
            audio_frame: The TeleCMI audio frame to publish.
        """
    ...
    def __str__(self):
        """String representation of the TeleCMI transport client."""
...
class TeleCMIInputTransport(BaseInputTransport):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            client: TeleCMITransportClient instance.
    ...
    async def start(self, frame: StartFrame):
        """Start the input transport and connect to TeleCMI room.
    ...
    async def stop(self, frame: EndFrame):
        """Stop the input transport and disconnect from TeleCMI room.
    ...
    async def cancel(self, frame: CancelFrame):
        """Cancel the input transport and disconnect from TeleCMI room.
...
class TeleCMIOutputTransport(BaseOutputTransport):
    ...
    Manages sending audio frames and data messages to TeleCMI room participants,
    including audio format conversion for TeleCMI compatibility.
    """
    ...
    async def start(self, frame: StartFrame):
        """Start the output transport and connect to TeleCMI room.
    ...
    async def stop(self, frame: EndFrame):
        """Stop the output transport and disconnect from TeleCMI room.
    ...
    async def cancel(self, frame: CancelFrame):
        """Cancel the output transport and disconnect from TeleCMI room.
    ...
    async def write_audio_frame(self, frame: OutputAudioRawFrame):
        """Write an audio frame to the TeleCMI room.
...
class TeleCMITransport(BaseTransport):
    ...
    def input(self) -> TeleCMIInputTransport:
        ...
        Returns:
            The TeleCMI input transport instance.
        """
        if not self._input:
    ...
    def output(self) -> TeleCMIOutputTransport:
        ...
        Returns:
            The TeleCMI output transport instance.
        """
        if not self._output:
    ...
    async def send_audio(self, frame: OutputAudioRawFrame):
        """Send an audio frame to the TeleCMI room.
