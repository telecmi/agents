...
from piopiy.services.azure.common import language_to_azure_language
from piopiy.services.tts_service import TTSService, WordTTSService
...
try:
    ...
    logger.error("In order to use Azure, you need to `pip install piopiy-ai[azure]`.")
