...
from piopiy.adapters.services.grok_realtime_adapter import GrokRealtimeLLMAdapter
...
try:
    ...
    logger.error("In order to use Grok Realtime, you need to `pip install piopiy-ai[grok]`.")
