...
from piopiy.services.stt_service import SegmentedSTTService, WebsocketSTTService
...
try:
    ...
    logger.error(
        "In order to use ElevenLabs Realtime STT, you need to `pip install piopiy-ai[elevenlabs]`."
    )
