...
.. deprecated:: 0.0.90
    ...
    piopiy.services.google.gemini_live.llm instead. Note that the new type names
...
from piopiy.services.google.gemini_live.llm import GeminiMediaResolution as _GeminiMediaResolution
from piopiy.services.google.gemini_live.llm import GeminiVADParams as _GeminiVADParams
from piopiy.services.google.gemini_live.llm import InputParams as _InputParams

with warnings.catch_warnings():
    warnings.simplefilter("always")
    warnings.warn(
        "Types in piopiy.services.gemini_multimodal_live.gemini are deprecated. "
        "Please use the equivalent types from "
        "piopiy.services.google.gemini_live.llm instead. Note that the new type "
