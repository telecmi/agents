...
from piopiy.adapters.services.bedrock_adapter import (
...
from piopiy.utils.tracing.service_decorators import traced_llm
...
try:
    ...
    logger.error(
        "In order to use AWS services, you need to `pip install piopiy-ai[aws]`. Also, remember to set `AWS_SECRET_ACCESS_KEY`, `AWS_ACCESS_KEY_ID`, and `AWS_REGION` environment variable."
    )
