...
from piopiy.adapters.services.open_ai_realtime_adapter import (
...
from piopiy.processors.aggregators.llm_response_universal import LLMContextAggregatorPair
...
try:
    ...
    logger.error("In order to use OpenAI, you need to `pip install piopiy-ai[openai]`.")
