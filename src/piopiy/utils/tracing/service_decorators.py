...
from piopiy.processors.aggregators.llm_context import NOT_GIVEN, LLMContext
from piopiy.processors.aggregators.openai_llm_context import OpenAILLMContext
from piopiy.utils.tracing.service_attributes import (
...
from piopiy.utils.tracing.turn_context_provider import get_current_turn_context
...
def traced_tts(func: Optional[Callable] = None, *, name: Optional[str] = None) -> Callable:
    ...
    def decorator(f):
        ...
        async def tracing_context(self, text):
            ...
            # Create span
            tracer = trace.get_tracer("piopiy")
