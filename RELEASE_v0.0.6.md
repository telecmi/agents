...
### ✅ Package Updates
- **Version**: Updated to `0.0.6` in `pyproject.toml`
...
### ✅ Documentation
- **CHANGELOG.md**: Complete changelog documenting all changes in v0.0.6
...
**Ready to release!** Follow the steps above to publish v0.0.6 to PyPI.
