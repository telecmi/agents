...
Requirements:
    pip install "piopiy-ai[deepgram,openai,playht,silero]"

Environment Variables:
    AGENT_ID, AGENT_TOKEN
    DEEPGRAM_API_KEY
    OPENAI_API_KEY
    PLAYHT_API_KEY - Get from https://play.ht/
    PLAYHT_USER_ID
"""
...
async def create_session(agent_id, call_id, from_number, to_number, metadata=None):
    print(f"📞 Call {call_id} - Using PlayHT TTS")
    
    voice_agent = VoiceAgent(
        instructions="You are a helpful AI assistant.",
        greeting="Hello! I'm using PlayHT for voice synthesis. How can I help you?",
    )
